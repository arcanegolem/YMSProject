...
/**
 * Этот юзкейс используется для подгрузки первого аккаунта если нет активного, потому что сейчас
 ...
 * то он будет использовваться только при первом запуске приложения чтобы хотя бы какой-то счет был на месте
 */
