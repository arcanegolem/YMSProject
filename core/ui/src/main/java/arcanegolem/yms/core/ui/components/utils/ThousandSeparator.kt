package arcanegolem.yms.core.ui.components.utils
 ...
 */
val VisualTransformation.Companion.ThousandSeparator
  @Composable
 ...
 * Кастомный вариант [VisualTransformation] для числа с плавающей точкой
 */
class ThousandSeparatorTransform : VisualTransformation {
